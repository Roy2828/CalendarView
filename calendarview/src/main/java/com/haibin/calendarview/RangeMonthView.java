...
public abstract class RangeMonthView extends BaseMonthView {
  ...
  ArrayList<Calendar> drawCalendarSize = new ArrayList<>();
    @Override
      ...
      //  onFinishDraw();
        for (int i = 0; i < mLineCount; i++) {
            for (int j = 0; j < 7; j++) {
                ...
                drawCalendarSize.add(calendar);
                onFinishDraw(drawCalendarSize);
    ...
    void onFinishDraw(ArrayList<Calendar> drawCalendarSize){

         if (drawCalendarSize != null && drawCalendarSize.size() > 0) {
                int i = drawCalendarSize.size() / 2;
                Calendar calendar1 = drawCalendarSize.get(i);
                onCenterCalendarIntercept(calendar1);
                Log.e("--------",drawCalendarSize.toString());
         }
     ...
     * @param isSelected 是否选中
     */
    protected abstract void onDrawText(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme, boolean isSelected, boolean isPreSelected,
